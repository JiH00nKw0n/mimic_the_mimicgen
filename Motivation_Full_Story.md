...
**셋째, 원본별 균등 뽑기는 오히려 나쁘다.** 블록 쌓기에서 **로봇 성공률**을 7.5%포인트 떨어뜨렸고(반복 6번 전부 같은 방향: −7.5, −8.5, −7.0, −10.5, −9.5, −2.0), 어느 작업에서도 이득을 준 적이 없다. 바늘 꿰기도 −3.3%포인트로 같은 방향이되 판정 문턱에 걸쳐 있고, 나머지 작업은 차이가 없었다.
...
| 작업 | 장면 종류 | 무작위 뽑기로 학습 | 거리 균등 뽑기로 학습 | 차이 |
|---|---|---|---|---|
| 커피 | 보통 (40) | 0.625 | 0.617 | −0.8%p |
| 커피 | 먼 장면 (80) | 0.296 | **0.375** | **+7.9%p** |
| 바늘 꿰기 | 보통 | 0.537 | 0.583 | +4.6%p |
| 바늘 꿰기 | 먼 장면 | 0.396 | 0.427 | +3.1%p |
| 세 조각 조립 | 보통 | 0.304 | 0.275 | −2.9%p |
| 세 조각 조립 | 먼 장면 | 0.127 | 0.152 | +2.5%p |
| 세 블록 쌓기 | 보통 | 0.662 | 0.667 | +0.4%p |
| 세 블록 쌓기 | 먼 장면 | 0.475 | 0.467 | −0.8%p |
| 머그 정리 | 보통 | 0.242 | 0.283 | +4.2%p |
| 머그 정리 | 먼 장면 | 0.169 | 0.133 | −3.5%p |
| 블록 쌓기 | 보통 | 0.858 | 0.812 | −4.6%p |
| 블록 쌓기 | 먼 장면 | 0.758 | 0.779 | +2.1%p |

(받는 쪽 물체가 멀리 옮겨진 장면 80개도 같은 평가 세트에 있으며, 본문에서 언급하는 해당 수치는 그 층의 것이다.)
