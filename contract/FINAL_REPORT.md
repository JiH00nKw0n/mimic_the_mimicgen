...
그대로는 0%, 시연을 사람 스타일로 재작성하고 3배 감속하면 8.5%였다(사람 6.5%와
표본 오차 범위가 겹쳐, 사람 수준에 도달한 것으로 판단한다. 단 표본이 성공 10~25개
수준이라 정밀 비교는 아니다). 4번의 상세 과정은 별도 문서로 관리하고, 이 보고서에서는 1번의 검증에
