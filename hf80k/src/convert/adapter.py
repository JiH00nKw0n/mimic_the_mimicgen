# Vendored verbatim from fr3_cube_stage1_handoff_20260801/common/controller_adapter.py
# (contract fr3_cube_stage1_model4500_legacyosc_v1, 2026-08-01). Do not edit — the
# handoff package is the source of truth; keep byte-identical below this line.
#!/usr/bin/env python3
