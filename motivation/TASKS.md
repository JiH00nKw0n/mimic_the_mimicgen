...
| 물체 | x | y | z_rot |
|---|---|---|---|
| machine | (-0.10, 0.20) | (-0.25, -0.05) | (-60°, 90°) |
| pod | (-0.25, 0.10) | (0.12, 0.33) | 고정 0 |

**Stack_D2E / StackThree_D2E**: 전 cube x,y = (±0.25), z_rot (0, 2π) 유지. (±0.30은 Panda 도달 한계 — 테이블 원거리 코너가 base에서 ~0.9m — 를 넘을 수 있어 1차 후보에서 제외. 프로브 결과가 여유로우면 ±0.28 재검토.)
